...
public class AliceFighting10 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AliceFighting10 window = new AliceFighting10();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Adoramus Blinds Hades(Soul)!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Hades(Soul) used Decrify!");
				lblMessageBox.setText("But Hades(Soul) was affected by Adoramus!");
				}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AliceFighting10 a10 = new AliceFighting10();
				a10.appear();
				frame.dispose();
