...
public class AliceFighting3 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AliceFighting3 window = new AliceFighting3();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Adoramus Blinds Belphegor!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Belphegor used Hunger Reap!");
				lblMessageBox.setText("But Belphegor was affected by Adoramus!");
				}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AliceFighting3 a3 = new AliceFighting3();
				a3.appear();
				frame.dispose();
