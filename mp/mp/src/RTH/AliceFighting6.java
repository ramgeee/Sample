...
public class AliceFighting6 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AliceFighting6 window = new AliceFighting6();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Adoramus Blinds Mammon!");
				}
				...
				if ( bBlind == true){
					...
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Abbadon used Severe lethargy!");
				    lblMessageBox.setText("But Abbadon was affected by Adoramus!");
				}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AliceFighting6 a6 = new AliceFighting6();
				a6.appear();
				frame.dispose();
