...
public class AliceFighting7 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AliceFighting7 window = new AliceFighting7();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Lucifer Blinds Mammon!");
				}
				...
				lblMessageBox.setText("But Lucifer was affected by Adoramus!");
				}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AliceFighting7 a7 = new AliceFighting7();
				a7.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\acer\\Documents\\Eclipse\\MP\\Resource\\Images\\7th.jpg"));
