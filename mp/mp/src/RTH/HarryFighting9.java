...
public class HarryFighting9 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting9 window = new HarryFighting9();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Hades(Body)!");
				}
				...
				if ( bBlind == true){
					...
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Hades(Body) used Soul Furnace!");
					lblMessageBox.setText("But Hades(Body) was stunned!");
					}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Hades(Body)!");
			}
		...
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\acer\\Documents\\Eclipse\\MP\\Resource\\Images\\9th.jpg"));
