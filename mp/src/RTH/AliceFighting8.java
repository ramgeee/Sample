...
public class AliceFighting8 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AliceFighting8 window = new AliceFighting8();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Adoramus Blinds Beelzebub!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Beelzebub used Deadly Swarm!");
				lblMessageBox.setText("But Beelzebub was affected by Adoramus!");
				}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AliceFighting8 a8 = new AliceFighting8();
				a8.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(AliceFighting8.class.getResource("/Images/8th.jpg")));
