...
public class AliceFighting9 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AliceFighting9 window = new AliceFighting9();
	...
	private void initialize() {
		...
		final JLabel lblNewLabel_3 = new JLabel("Hades(Body)");
		...
		final JLabel lblMammonHP = new JLabel("8000000");
		...
		final JLabel lblStage = new JLabel("Stage 9");
		...
		final JButton btnHolyLight = new JButton("Holy Light");
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					btnHolyLight.setEnabled(false);
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Hades(Body) used Special Attack!");
					lblMessageBox.setText("DOOM!");
				}else{
					nAliceHP -= 800000;
	                nCtr++;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Hades(Body) used Soul Furnace!");
					btnHolyLight.setEnabled(true);
				}	
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Adoramus Blinds Hades(Body)!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Hades(Body) used Soul Furnace!");
				lblMessageBox.setText("But Hades(Body) was affected by Adoramus!");
				}
					...
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Hades(Body) used SoulFurnace!");
		...
		lblNewLabel_1.setIcon(new ImageIcon(AliceFighting1.class.getResource("/Images/Hades(body).gif")));
		lblNewLabel_1.setBounds(504, 214, 215, 195);
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AliceFighting9 a9 = new AliceFighting9();
				a9.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(AliceFighting9.class.getResource("/Images/9th.jpg")));
