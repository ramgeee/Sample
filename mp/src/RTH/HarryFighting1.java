...
public class HarryFighting1 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting1 window = new HarryFighting1();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Mammon!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Mammon used Greed Smite!");
				lblMessageBox.setText("But Mammon was stunned!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Mammon!");
			}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting1 h1 = new HarryFighting1();
				h1.appear();
				frame.dispose();
		...
		lblNewLabel_5.setIcon(new ImageIcon(HarryFighting1.class.getResource("/Images/1st.jpg")));
