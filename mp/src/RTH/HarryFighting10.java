...
public class HarryFighting10 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting10 window = new HarryFighting10();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Hades(Soul)!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Hades(Soul)!");
			}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting10 h10 = new HarryFighting10();
				h10.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting10.class.getResource("/Images/10th.jpg")));
