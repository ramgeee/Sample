...
public class HarryFighting2 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting2 window = new HarryFighting2();
	...
	private void initialize() {
		...
		lblNewLabel_3.setBounds(474, 40, 252, 31);
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Asmodeus used Harrasment!");
				}
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Asmodeus!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Asmodeus used Harrasment!");
				lblMessageBox.setText("But Asmodeus was stunned!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Asmodeus!");
			}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting2 h2 = new HarryFighting2();
				h2.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting2.class.getResource("/Images/2nd.jpg")));
