...
public class HarryFighting3 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting3 window = new HarryFighting3();
	...
	private void initialize() {
		...
		final JLabel lblNewLabel_3 = new JLabel("Belphegor");
		lblNewLabel_3.setForeground(Color.WHITE);
		lblNewLabel_3.setFont(new Font("Diablo", Font.ITALIC, 40));
		lblNewLabel_3.setBounds(474, 40, 250, 31);
		...
		final JLabel lblMammonHP = new JLabel("2500000");
		...
		final JLabel lblStage = new JLabel("Stage 3");
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					sMammonHP = nMammonHP.toString();
					lblMammonHP.setText(sMammonHP);
					lblMessageBox.setText("Belphegor used Special Attack!");
					lblMessageBox.setText("Consumption!");
				}else{
					nAliceHP -= 155000;
	                nCtr++;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Belphegor used Hunger Reap!");
				}		
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Belphegor!");
				}
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Belphegor used Hunger Reap!");
				lblMessageBox.setText("But Belphegor was stunned!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Belphegor!");
			}
		...
		lblNewLabel_1.setIcon(new ImageIcon(AliceFighting1.class.getResource("/Images/Belphegor.gif")));
		lblNewLabel_1.setBounds(598, 214, 126, 176);
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting3 h3 = new HarryFighting3();
				h3.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting3.class.getResource("/Images/3rd.jpg")));
