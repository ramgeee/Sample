...
public class HarryFighting4 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting4 window = new HarryFighting4();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Lilith used Demonic Force!");
				lblMessageBox.setText("But Lilith was stunned!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Lilith!");
			}
			...
			sAliceHP = nAliceHP.toString();
			lblAliceHP.setText(sAliceHP);
			lblMessageBox.setText(" Lilith used Demon Force!");
			lblMessageBox.setText(" But Lilith was stunned!");
			}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting4 h4 = new HarryFighting4();
				h4.appear();
				frame.dispose();
			}
		});
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting4.class.getResource("/Images/4th.jpg")));
