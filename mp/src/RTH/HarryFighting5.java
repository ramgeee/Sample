...
public class HarryFighting5 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting5 window = new HarryFighting5();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Leviathan!");
				}
				...
				if ( bBlind == true){
					...
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Leviathan used Envious Blow!");
					lblMessageBox.setText("But Leviathan was stunned!");
				}
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting5 h5 = new HarryFighting5();
				h5.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting5.class.getResource("/Images/5th.jpg")));
