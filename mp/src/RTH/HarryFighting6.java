...
public class HarryFighting6 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting6 window = new HarryFighting6();
	...
	private void initialize() {
		...
		final JLabel lblNewLabel_3 = new JLabel("Abbadon");
		...
		final JLabel lblMammonHP = new JLabel("4000000");
		...
		final JLabel lblStage = new JLabel("Stage 6");
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					sMammonHP = nMammonHP.toString();
					lblMammonHP.setText(sMammonHP);
					lblMessageBox.setText("Abbadon used Special Attack!");
					lblMessageBox.setText("Mach Blow!");
				}else{
					nAliceHP -= 400000;
					nMammonHP -= 200000;
					sMammonHP = nMammonHP.toString();
					...
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Abbadon used Severe lethargy!");
				}
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Lilith!");
				}
				...
				if ( bBlind == true){
					...
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Abbadon used Severe lethargy!");
				    lblMessageBox.setText("But Abbadon was stunned!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Abbadon!");
			}
		...
		lblNewLabel_1.setIcon(new ImageIcon(AliceFighting1.class.getResource("/Images/Abbadon.gif")));
		lblNewLabel_1.setBounds(514, 214, 188, 208);
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				HarryFighting6 h6 = new HarryFighting6();
				h6.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting6.class.getResource("/Images/6th.jpg")));
