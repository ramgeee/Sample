...
public class HarryFighting8 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HarryFighting8 window = new HarryFighting8();
	...
	private void initialize() {
		...
		btnAliceSkill1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				lblMessageBox.setText("Abyssal Marsh stuns Beezlebub!");
				}
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Jack Frost Marsh stuns Beezlebub!");
			}
		...
		lblNewLabel_6.setIcon(new ImageIcon(HarryFighting8.class.getResource("/Images/8th.jpg")));
