...
public class ThanaFight1 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanaFight1 window = new ThanaFight1();
	...
	private void initialize() {
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Transmission stuns Mammon!");
			String sStacks = lblStacks.getText();
			Integer nStacks = 0;
			nStacks = nStacks.parseInt(sStacks);
		...
		lblNewLabel_6.setIcon(new ImageIcon(ThanaFight1.class.getResource("/Images/1st.jpg")));
