...
public class ThanaFight10 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanaFight10 window = new ThanaFight10();
	...
	private void initialize() {
		...
		final JLabel lblNewLabel_3 = new JLabel("Hades(Soul)");
		lblNewLabel_3.setForeground(Color.WHITE);
		lblNewLabel_3.setFont(new Font("Diablo", Font.ITALIC, 40));
		lblNewLabel_3.setBounds(474, 40, 300, 31);
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 2 == 0){
					...
					lblMessageBox.setText("Hades(Soul) used Special Attack!");
					lblMessageBox.setText("Souls of Nightmares!");
				}else{
					nAliceHP -= 250000;
	                nCtr++;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Hades(Soul) used Decrify!");
				}	
		...
		btnHolyLight.setBounds(35, 372, 151, 53);
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Transmission stuns Hades(Soul)!");
			String sStacks = lblStacks.getText();
			Integer nStacks = 0;
			nStacks = nStacks.parseInt(sStacks);
			...
			if ( bBlind == true){
				...
				lblAliceHP.setText(sAliceHP);
				lblMessageBox.setText("Hades(Soul) used Decrify!");
				lblMessageBox.setText("But Hades(Soul) was stunned!");
				}
		...
		lblNewLabel_1.setIcon(new ImageIcon(AliceFighting1.class.getResource("/Images/Hades(soul).gif")));
		lblNewLabel_1.setBounds(576, 214, 113, 176);
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ThanaFight10 t10 = new ThanaFight10();
				t10.appear();
				frame.dispose();
		...
		lblNewLabel_5.setBounds(200, 403, 91, 31);
		frame.getContentPane().add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("New label");
		lblNewLabel_6.setIcon(new ImageIcon(ThanaFight10.class.getResource("/Images/10th.jpg")));
