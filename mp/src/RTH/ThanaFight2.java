...
public class ThanaFight2 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanaFight2 window = new ThanaFight2();
	...
	private void initialize() {
		...
		lblNewLabel_3.setBounds(474, 40, 236, 31);
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Transmission stuns Asmodeus!");
			String sStacks = lblStacks.getText();
			Integer nStacks = 0;
			nStacks = nStacks.parseInt(sStacks);
		...
		lblNewLabel_6.setIcon(new ImageIcon(ThanaFight2.class.getResource("/Images/2nd.jpg")));
