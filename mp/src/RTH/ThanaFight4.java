...
public class ThanaFight4 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanaFight4 window = new ThanaFight4();
	...
	private void initialize() {
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Transmission stuns Lilith!");
			String sStacks = lblStacks.getText();
			Integer nStacks = 0;
			nStacks = nStacks.parseInt(sStacks);
		...
		lblNewLabel_6.setIcon(new ImageIcon(ThanaFight4.class.getResource("/Images/4th.jpg")));
