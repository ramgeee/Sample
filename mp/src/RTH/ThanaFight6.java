...
public class ThanaFight6 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanaFight6 window = new ThanaFight6();
	...
	private void initialize() {
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Transmission stuns Abbadon!");
			String sStacks = lblStacks.getText();
			Integer nStacks = 0;
			nStacks = nStacks.parseInt(sStacks);
		...
		lblNewLabel_6.setIcon(new ImageIcon(ThanaFight6.class.getResource("/Images/6th.jpg")));
