...
public class ThanaFight9 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanaFight9 window = new ThanaFight9();
	...
	private void initialize() {
		...
		final JButton btnHolyLight = new JButton("Soul Strike");
		...
		btnAliceSkill2.addActionListener(new ActionListener() {
			...
			lblMessageBox.setText("Transmission stuns Hades(Body)!");
			String sStacks = lblStacks.getText();
			Integer nStacks = 0;
			nStacks = nStacks.parseInt(sStacks);
		...
		lblNewLabel_6.setIcon(new ImageIcon(ThanaFight9.class.getResource("/Images/9th.jpg")));
