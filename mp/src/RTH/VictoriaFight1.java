...
public class VictoriaFight1 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight1 window = new VictoriaFight1();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(35, 40, 226, 31);
		...
		final JLabel lblNewLabel_3 = new JLabel("Mammon");
		...
		final JLabel lblMammonHP = new JLabel("1500000");
		...
		final JLabel lblStage = new JLabel("Stage 1");
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					lblMessageBox.setText("Mammon used Special Attack!");
					lblMessageBox.setText("Mass Scarcity");
				}else{
					nAliceHP -= 150000;
	                nCtr++;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Mammon used Greed Smite!");
				}	
		...
		final JButton btnAliceSkill1 = new JButton("Mooonlight Waltz");
		...
		btnAliceSkill3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					nAliceHP -= 200000 - Siren - lash;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Mammon used Special Attack!");
					lblMessageBox.setText("Mass Scarcity");
				}else{
					nAliceHP -= 150000 - lash - Siren;
	                nCtr++;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Mammon used Greed Smite!");
		...
		lblNewLabel_1.setIcon(new ImageIcon(AliceFighting1.class.getResource("/Images/Mammon.gif")));
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight1 v1 = new VictoriaFight1();
				v1.appear();
				frame.dispose();
		...
		lblNewLabel_5.setIcon(new ImageIcon(VictoriaFight1.class.getResource("/Images/1st.jpg")));
