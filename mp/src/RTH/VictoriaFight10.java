...
public class VictoriaFight10 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight10 window = new VictoriaFight10();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(35, 40, 251, 31);
		...
		btnAliceSkill3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    if(nCtr % 2 == 0){
					nAliceHP -= 250000 - Siren - lash;
					sAliceHP = nAliceHP.toString();
					nMammonHP += 250000 - Siren - lash;
					sMammonHP = nMammonHP.toString();
					lblMammonHP.setText(sMammonHP);
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Hades(Soul) used Special Attack!");
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight10 v10 = new VictoriaFight10();
				v10.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight10.class.getResource("/Images/10th.jpg")));
