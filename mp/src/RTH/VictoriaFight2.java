...
public class VictoriaFight2 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight2 window = new VictoriaFight2();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(35, 40, 229, 31);
		...
		lblNewLabel_3.setBounds(474, 40, 255, 31);
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Asmodeus used Harassment!");
				}	
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight2 v2 = new VictoriaFight2();
				v2.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight2.class.getResource("/Images/2nd.jpg")));
