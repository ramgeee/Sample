...
public class VictoriaFight3 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight3 window = new VictoriaFight3();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(35, 40, 234, 31);
		...
		btnAliceSkill3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					nMammonHP += 300000 - Siren - lash;
					sMammonHP = nMammonHP.toString();
					lblMammonHP.setText(sMammonHP);
					lblMessageBox.setText("Belphegor used Special Attack!");
					lblMessageBox.setText("Consumption!");
				}else{
					nAliceHP -= 155000 - Siren - lash;
	                nCtr++; 
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Belphegor used Hunger Reap!");
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight3 v3 = new VictoriaFight3();
				v3.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight3.class.getResource("/Images/3rd.jpg")));
