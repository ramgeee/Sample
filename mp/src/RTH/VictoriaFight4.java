...
public class VictoriaFight4 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight4 window = new VictoriaFight4();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(35, 40, 240, 31);
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight4.class.getResource("/Images/4th.jpg")));
