...
public class VictoriaFight5 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight5 window = new VictoriaFight5();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(35, 40, 230, 31);
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					lblMessageBox.setText("Life Jealousy!");
				}else{
					nAliceHP -= 320000;
	                nCtr++;
					sAliceHP = nAliceHP.toString();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight5.class.getResource("/Images/5th.jpg")));
