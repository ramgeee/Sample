...
public class VictoriaFight6 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight6 window = new VictoriaFight6();
	...
	private void initialize() {
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight6 v6 = new VictoriaFight6();
				v6.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight6.class.getResource("/Images/6th.jpg")));
