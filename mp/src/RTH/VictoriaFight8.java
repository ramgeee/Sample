...
public class VictoriaFight8 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight8 window = new VictoriaFight8();
	...
	private void initialize() {
		...
		btnHolyLight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					...
					lblMessageBox.setText("Beezlebub used Special attack!");
					...
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Beezlebub used Deadly Swarm!");
				}	
		...
		btnAliceSkill4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(nCtr % 4 == 0){
					nAliceHP -= 300000 - Siren - lash;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Beezlebub used Special attack!");
					lblMessageBox.setText("Unholy Eater");
				}else{
					nAliceHP -= 500000 - Siren - lash;
					nCtr ++;
					sAliceHP = nAliceHP.toString();
					lblAliceHP.setText(sAliceHP);
					lblMessageBox.setText("Beezlebub used Deadly Swarm!");
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight8 v8 = new VictoriaFight8();
				v8.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight8.class.getResource("/Images/8th.jpg")));
