...
public class VictoriaFight9 {
	...
	public static void appear() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VictoriaFight9 window = new VictoriaFight9();
	...
	private void initialize() {
		...
		final JButton btnHolyLight = new JButton("Deadly Lash");
		...
		btnRetry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VictoriaFight9 v9 = new VictoriaFight9();
				v9.appear();
				frame.dispose();
		...
		lblNewLabel_6.setIcon(new ImageIcon(VictoriaFight9.class.getResource("/Images/9th.jpg")));
